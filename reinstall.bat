...
set confhome=https://raw.githubusercontent.com/rirh/reinstall/main
set confhome_cn=https://cnb.cool/rirh/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/rirh/reinstall/main
